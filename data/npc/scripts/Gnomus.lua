...
local function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, "measurements") and npcHandler.topic[cid] == 1 then
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Measurements ) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskMeasurements) < os.stime() then -- Ainda não se passaram as 20h
			npcHandler:say({"I don't need your help for now. Come back later."}, cid)
			playerTopic[cid] = 1
			npcHandler.topic[cid] = 1
		end
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Measurements) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskMeasurements) > os.stime() then -- Vai fazer a missão após 20h
		...
		elseif player:getStorageValue(Storage.DangerousDepths.Gnomes.Measurements) == 1 and player:getStorageValue(Storage.DangerousDepths.Gnomes.locationCount) == 5 then -- Não possuía a missão, agora possui!
			...
			player:setStorageValue(Storage.DangerousDepths.Gnomes.timeTaskMeasurements, os.stime() + tempo)
	...
	if msgcontains(msg, "ordnance") and npcHandler.topic[cid] == 1 then
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Ordnance) == 3 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskOrdnance) < os.stime() then -- Ainda não se passaram as 20h
			npcHandler:say({"I don't need your help for now. Come back later."}, cid)
			playerTopic[cid] = 1
			npcHandler.topic[cid] = 1
		end
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Ordnance) == 3 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskOrdnance) > os.stime() then -- Vai fazer a missão após 20h
		...
		elseif player:getStorageValue(Storage.DangerousDepths.Gnomes.Ordnance) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.GnomesCount) >= 5 then -- Não possuía a missão, agora possui!
			if player:getStorageValue(Storage.DangerousDepths.Gnomes.CrawlersCount) >= 3 then
				...
				player:setStorageValue(Storage.DangerousDepths.Gnomes.timeTaskOrdnance, os.stime() + tempo)
	...
	if msgcontains(msg, "charting") and npcHandler.topic[cid] == 1 then
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Charting) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskCharting) < os.stime() then -- Ainda não se passaram as 20h
			npcHandler:say({"I don't need your help for now. Come back later."}, cid)
			playerTopic[cid] = 1
			npcHandler.topic[cid] = 1
		end
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Charting) == 2 and player:getStorageValue(Storage.DangerousDepths.Gnomes.timeTaskCharting) > os.stime() then -- Vai fazer a missão após 20h
		...
		if player:getStorageValue(Storage.DangerousDepths.Gnomes.Charting) == 1 and player:getStorageValue(Storage.DangerousDepths.Gnomes.ChartingCount) >= 3 then -- Não possuía a missão, agora possui!
			...
			player:setStorageValue(Storage.DangerousDepths.Gnomes.timeTaskCharting, os.stime() + tempo)
			playerTopic[cid] = 1
			npcHandler.topic[cid] = 1
		end
