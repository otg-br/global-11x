...
local voices = {
	...
	{ text = 'Hello, is this your first visit to Issavi? I can show you around a little.' },
	{ text = 'I can tell you all about the status this world is in.' },
	{ text = 'Talk to me if you need directions.' },
	{ text = 'Need some help finding your way through Issavi?' }
}

npcHandler:addModule(VoiceModule:new(voices))

local configMarks = {
	{mark = "shops", position = Position(33915, 31513, 7), markId = MAPMARK_BAG, description = "Shops"},
	{mark = "depot", position = Position(33921, 31480, 7), markId = MAPMARK_LOCK, description = "Depot"},
	{mark = "temple", position = Position(33921, 31477, 5), markId = MAPMARK_TEMPLE, description = "Temple"}
}
...
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'I\'ll help you find your way through Issavi, the amazon town. I can mark important locations on your map and give you some information about the town and the world status.'})
...
npcHandler:setMessage(MESSAGE_GREET, "Welcome to Issavi, |PLAYERNAME| Would you like some information and a map guide?")
