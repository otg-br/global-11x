...
local config = {
	['blue piece of cloth'] = {storageValue = 1, text = {'Brought the 50 pieces of blue cloth?', 'Good. Get me 50 {pieces of green cloth} now.'}, itemId = 5912, count = 50},
	['green piece of cloth'] = {storageValue = 2, text = {'Brought the 50 pieces of green cloth?', 'Good. Get me 50 {pieces of red cloth} now.'}, itemId = 5910, count = 50},
	['red piece of cloth'] = {storageValue = 3, text = {'Brought the 50 pieces of red cloth?', 'Good. Get me 50 {pieces of brown cloth} now.'}, itemId = 5911, count = 50},
	['brown piece of cloth'] = {storageValue = 4, text = {'Brought the 50 pieces of brown cloth?', 'Good. Get me 50 {pieces of yellow cloth} now.'}, itemId = 5913, count = 50},
	['yellow piece of cloth'] = {storageValue = 5, text = {'Brought the 50 pieces of yellow cloth?', 'Good. Get me 50 {pieces of white cloth} now.'}, itemId = 5914, count = 50},
	['white piece of cloth'] = {storageValue = 6, text = {'Brought the 50 pieces of white cloth?', 'Good. Get me 10 {spools of yarn} now.'}, itemId = 5909, count = 50},
