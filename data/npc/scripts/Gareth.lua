...
local function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, "extension") then
		if player:getStorageValue(Storage.secretLibrary.MoTA.Questline) == 1 then
			...
			playerTopic[cid] = 6
		elseif player:getStorageValue(Storage.secretLibrary.MoTA.Questline) == 6 then
			npcHandler:say({"Those who are accorded the honours to visit this exclusive place will smash their blindness and face the truth. ..."}, cid)
			player:setStorageValue(Storage.secretLibrary.MoTA.Questline, 7)
		end
	elseif msgcontains(msg, "problem") and npcHandler.topic[cid] == 6 then
	...
	elseif msgcontains(msg, "yes") and npcHandler.topic[cid] == 7 then
		...
		npcHandler.topic[cid] = 1
		playerTopic[cid] = 1
		player:setStorageValue(Storage.secretLibrary.MoTA.Questline, 2)
	elseif msgcontains(msg, "bone") and player:getStorageValue(Storage.secretLibrary.MoTA.Questline) == 4 then
		...
		player:setStorageValue(Storage.secretLibrary.MoTA.Questline, 5)
		npcHandler.topic[cid] = 1
		playerTopic[cid] = 1
	end
	return true
