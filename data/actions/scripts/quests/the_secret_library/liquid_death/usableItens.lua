local config = {
	statues = {
		[1] = {position = Position(33598, 31398, 14), storage = Storage.secretLibrary.LiquidDeath.Statue1},
		[2] = {position = Position(33602, 31439, 13), storage = Storage.secretLibrary.LiquidDeath.Statue2},
		[3] = {position = Position(33587, 31461, 14), storage = Storage.secretLibrary.LiquidDeath.Statue3},
		[4] = {position = Position(33588, 31461, 14), storage = Storage.secretLibrary.LiquidDeath.Statue4},
		[5] = {position = Position(33549, 31459, 14), storage = Storage.secretLibrary.LiquidDeath.Statue5},
		[6] = {position = Position(33577, 31475, 15), storage = Storage.secretLibrary.LiquidDeath.Statue6},
		[7] = {position = Position(33612, 31465, 15), storage = Storage.secretLibrary.LiquidDeath.Statue7},
		[8] = {position = Position(33565, 31423, 13), storage = Storage.secretLibrary.LiquidDeath.Statue8},
		[9] = {position = Position(33574, 31441, 15), storage = Storage.secretLibrary.LiquidDeath.Statue9}
	},
	bookInfo = {
		id = 15475,
		position = Position(32881, 32435, 8),
		storage = Storage.secretLibrary.LiquidDeath.Questline, value = 3,
	...
	fixedId = {17239, 17242},
	countStatues = Storage.secretLibrary.LiquidDeath.statueCount,
	maxValue = 9
}
...
function onUse(player, item, position, fromPosition, pos, target, toPosition)
				...
				if position == k.position then
					if player:getStorageValue(k.storage) < 1 then
						...
						if player:getStorageValue(config.countStatues) == config.maxValue then
							player:setStorageValue(Storage.secretLibrary.LiquidDeath.Questline, player:getStorageValue(Storage.secretLibrary.LiquidDeath.Questline) + 1)
						end
