...
local monsters = {'wereboar', 'werebadger'} -- monstros que v�o nascer em tal dia...
local spawnDay = 13
...
function Game.createRandom(position)
	...
	if monster then
		...
		monster:remove() -- tem que remover sen�o nascem 2... mas como o respawn � r�pido ningu�m percebe
	end
    return true
end
function onStartup()
