...
function onSay(player, words, param)
	...
	if reloads >= 10 then
		player:sendTextMessage(MESSAGE_STATUS_CONSOLE_BLUE,
			"Por medidas de seguran�a, s� � permitido 10 reloads no server at� que fique arrumado")
		return false
	end
	...
	-- 	player:sendTextMessage(MESSAGE_STATUS_CONSOLE_BLUE,
	-- 		"Por medidas de seguran�a, esse reload est� desativado at� que fique arrumado")
	-- 	return false
	-- end
