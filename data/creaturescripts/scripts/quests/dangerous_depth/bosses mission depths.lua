...
function onKill(player, creature)
	...
	local bosses = {
		["the count of the core"] = {stg = Storage.DangerousDepths.Bosses.theCountOfTheCore, value = os.stime() + 20*60*60, teleportPosition = Position(33681, 32340, 15),
		toPosition = Position(33682, 32315, 15), toPositionBack = Position(33324, 32111, 15)},
		["the duke of the depths"] = {stg = Storage.DangerousDepths.Bosses.theDukeOfTheDepths, value = os.stime() + 20*60*60, teleportPosition = Position(33719, 32302, 15),
		toPosition = Position(33691, 32301, 15), toPositionBack = Position(33275, 32318, 15)},
		["the baron from below"] = {stg = Storage.DangerousDepths.Bosses.theBaronFromBelow, value = os.stime() + 20*60*60, teleportPosition = Position(33650, 32312, 15),
