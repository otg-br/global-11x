...
class ProtocolLogin : public Protocol
{
	...
	protected:
		...
		void addWorldInfo(OutputMessage_ptr& output, const std::string& accountName, const std::string& password, uint16_t version, bool isLiveCastLogin, uint16_t proxyId = 0);
};
